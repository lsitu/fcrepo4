...
public class FedoraLdpIT extends AbstractResourceIT {
    ...
    public void testConcurrentPutDatastreamResource() throws InterruptedException,
        ...
        concurrentSNSDataStreamIngest(putDSFileMethod(pid, getRandomUniqueId(), TEST_FILE));
    }
    ...
    public void testConcurrentPostDatastreamResource() throws InterruptedException,
        ...
        concurrentSNSDataStreamIngest(postDSFileMethod(pid, getRandomUniqueId(), TEST_FILE));
    }
